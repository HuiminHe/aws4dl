...
# Path to your oh-my-zsh installation.
  export ZSH=/home/hh162/.oh-my-zsh
...
alias re="sudo service network-manager restart"
alias dbx='bash ~/.dbx.sh'
alias eprint='python /home/hh162/code/eprint/gui.py'
alias cv='cd ~/code/reactor/src/cv_modeling'
...
export PATH="/usr/bin/blender-2.78/:$PATH"
